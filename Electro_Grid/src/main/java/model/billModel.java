...
public class billModel {
	...
	public String getBill() {
		...
		try {
			...
			data = "<table id='dataTable' class='display' style='width: 100%'><thead>"
		            +"<tr>"
			...
			while (resultSet.next()) {
				...
				data = data+"<tr><td style='border: 1px solid black;'>"+resultSet.getString(1)+"</td>"
						...
						+ "<td style='border: 1px solid black;'><button type='button' class='btnselect btn btn-info p-2 w-100'>Select</button></td>"
					  + "</tr>";
